  ...
  describe('gd.Serializer', function() {
    it('should serialize a Text Object', function() {
      ...
      expect(jsonObject).toBe(
        '{"bold": false,"italic": false,"name": "testObject","smoothed": true,"type": "TextObject::Text","underlined": false,"wrapping": false,"wrappingWidth": 256,"variables": [],"behaviors": [],"string": "Text of the object, with 官话 characters","font": "","characterSize": 20,"color": {"b": 255,"g": 255,"r": 255}}'
      );
    });
  });
